...
test('commander career and statistics expose unique commander records', () => {
  ...
  expect(career).toMatch(/<span>Exploration<\/span><h3[^>]*>PIONEER<\/h3>/)
  expect(career).not.toContain('>Exploration</h3>')
  expect(career).toContain('commander-reputation-card')
  expect(career).toContain('aria-label="Federation reputation"')
  expect(career).toContain('<span>Federation</span>')
