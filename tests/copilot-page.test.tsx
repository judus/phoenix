...
test('Copilot chat is conversation-first and exposes compact voice control', () => {
  const markup = renderToStaticMarkup(<CopilotVoiceProvider api={api} clientIdentity={identity} events={events}><CopilotPage api={api} clientIdentity={identity} events={events} view="chat" /></CopilotVoiceProvider>)
...
test('Copilot profiles reserve the protected character editor surface', () => {
  const markup = renderToStaticMarkup(<CopilotVoiceProvider api={api} clientIdentity={identity} events={events}><CopilotPage api={api} clientIdentity={identity} events={events} view="profiles" /></CopilotVoiceProvider>)
