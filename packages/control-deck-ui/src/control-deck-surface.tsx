...
import type {
  ControlDeckCommandElement,
  ControlDeckDeck,
  ControlDeckSpacerElement
} from '@jdu/control-deck-core'

export interface ControlDeckEmptyCell {
  column: number
  row: number
  spacer?: ControlDeckSpacerElement
}

export interface ControlDeckSurfaceProps {
  'aria-label': string
  className?: string
  deck: ControlDeckDeck
  renderCommand(element: ControlDeckCommandElement): ReactNode
  renderEmpty(cell: ControlDeckEmptyCell): ReactNode
}
