...
copy('licenses')
copyAbsolute(resolve(projectRoot, 'node_modules/control-deck/LICENSE'), resolve(outputRoot, 'licenses/Control-Deck-PHOENIX-Runtime-Licence.txt'))
copyAbsolute(resolve(projectRoot, 'node_modules/control-deck/licenses/THIRD_PARTY_NOTICES.md'), resolve(outputRoot, 'licenses/Control-Deck-Third-Party-Notices.md'))
