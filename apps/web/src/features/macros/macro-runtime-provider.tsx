...
import { createCopilotId } from '../copilot/copilot-client-identity.js'
...
export function MacroRuntimeProvider ({ api, children }: { api: PhoenixApi, children: ReactNode }) {
  ...
  }), [api, draft, error, library, playback, recording, settings])
