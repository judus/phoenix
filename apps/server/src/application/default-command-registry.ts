...
export const PHOENIX_NAVIGATION_DESTINATIONS: readonly NavigationCommandDestination[] = [
  ...
  destination('commander.loadouts', 'Suit loadouts', '#/commander/loadouts', 'Commander', 'Open observed suit loadouts.'),
  ...
  destination('equipment.planner', 'Personal equipment planner', '#/equipment/planner', 'Equipment', 'Preview suit and personal weapon upgrade plans.'),
  ...
  destination('comms.contacts', 'Correspondents', '#/comms/contacts', 'Comms', 'Open observed commander correspondents.'),
